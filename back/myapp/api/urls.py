...
urlpatterns = [
    ...
    path('plan/',PlanViewSet.as_view({'get': 'list', 'post': 'create'}), name='plan-list'),
    path('plan/<int:user_id>/', PlanViewSet.as_view({'get': 'retrieve', 'put': 'update', 'patch': 'partial_update', 'delete': 'destroy'}), name='plan-detail')
]
